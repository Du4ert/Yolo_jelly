...
Минимальное изменение глубины:

```text
min_depth_change = 0.1 м
```

В GUI-процессоре параметр может передаваться как `0.3 м`.
...
Эффективная дистанция обнаружения `d_eff` берётся одним из способов:
